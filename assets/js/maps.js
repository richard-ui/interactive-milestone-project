...
function initMap(lat1 = 53.465590, lng2 = -2.348213) {
  ...
  // Multiple array of locations for cities.
    ...
    locations1 = [
        ...
        '<div><button type="button" id="chief" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.465590, -2.348213, 1, "Big Chief", 10],
        ...
        '<div><button type="button" id="lexDeux" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.446622, -2.308713, 2, "Lex Deux", 8],
        ...
        ['<h1 class="info_Heading">Knights Town</h1>' +
            ...
            '<div><button type="button" id="knight" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.477314, -2.254962, 1, "Knights Town", 10],
        ...
        ['<h1 class="info_Heading">Black Star</h1>' +
            ...
            '<div><button type="button" id="bk-star" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.451003, -2.203978, 12, "Black Star", 10]
    ...
    locations2 = [
        ...
        '<div><button type="button" id="benson" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.417375, -2.924687, 1, "Benson Lodge", 10],
         ...
         ['<h1 class="info_Heading">El Porto</h1>' +
            ...
            '<div><button type="button" id="el-porto" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.392814, -2.935674, 12, "El Porto", 10],
        ...
        ['<h1 class="info_Heading">Little Italy</h1>' +
            ...
            '<div><button type="button" id="lil-italy" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.423512, -2.918507, 2, "Little Italy", 10]
    ...
    locations3 = [
        ...
        '<div><button type="button" id="cafeChoc" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.820898, -1.743720, 1, "cafe chocolat", 10],
        ...
        '<div><button type="button" id="dirtybones" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.791704, -1.734107, 1, "Dirty Bones", 10],
        ...
        '<div><button type="button" id="forman" onclick="Choice(this);" class="btn btn-primary info-btn">Reservation</button></div></div>', 53.801640, -1.796248, 1, "Fish Forman", 10]
